...
Always check reference.md when working on creating custom visual. Before completing any user request check if any link from reference.md is applicable to the task.
